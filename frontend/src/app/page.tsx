  ...
  return (
    ...
    <div className="m-2 p-4 flex flex-col justify-right gap-2">
      ...
      <select className="select bg-white text-black border-1 border-black rounded p-2 " >
        <option className="hover:bg-black hover:text-white" value="null">Niewiem</option>
        <option className="hover:bg-black hover:text-white" value="00:00 - 1:00">00:00 - 1:00</option>
        <option className="hover:bg-black hover:text-white" value="1:00 - 2:00">1:00 - 2:00</option>
        <option className="hover:bg-black hover:text-white" value="2:00 - 3:00">2:00 - 3:00</option>
        <option className="hover:bg-black hover:text-white" value="3:00 - 4:00">3:00 - 4:00</option>
        <option className="hover:bg-black hover:text-white" value="4:00 - 5:00">4:00 - 5:00</option>
        <option className="hover:bg-black hover:text-white" value="5:00 - 6:00">5:00 - 6:00</option>
        <option className="hover:bg-black hover:text-white" value="6:00 - 7:00">6:00 - 7:00</option>
        <option className="hover:bg-black hover:text-white" value="7:00 - 8:00">7:00 - 8:00</option>
        <option className="hover:bg-black hover:text-white" value="8:00 - 9:00">8:00 - 9:00</option>
        <option className="hover:bg-black hover:text-white" value="9:00 - 10:00">9:00 - 10:00</option>
        <option className="hover:bg-black hover:text-white" value="10:00 - 11:00">10:00 - 11:00</option>
        <option className="hover:bg-black hover:text-white" value="11:00 - 12:00">11:00 - 12:00</option>
        <option className="hover:bg-black hover:text-white" value="12:00 - 13:00">12:00 - 13:00</option>
        <option className="hover:bg-black hover:text-white" value="13:00 - 14:00">13:00 - 14:00</option>
        <option className="hover:bg-black hover:text-white" value="14:00 - 15:00">14:00 - 15:00</option>
        <option className="hover:bg-black hover:text-white" value="15:00 - 16:00">15:00 - 16:00</option>
        <option className="hover:bg-black hover:text-white" value="16:00 - 17:00">16:00 - 17:00</option>
        <option className="hover:bg-black hover:text-white" value="17:00 - 18:00">17:00 - 18:00</option>
        <option className="hover:bg-black hover:text-white" value="18:00 - 19:00">18:00 - 19:00</option>
        <option className="hover:bg-black hover:text-white" value="19:00 - 20:00">19:00 - 20:00</option>
        <option className="hover:bg-black hover:text-white" value="20:00 - 21:00">20:00 - 21:00</option>
        <option className="hover:bg-black hover:text-white" value="21:00 - 22:00">21:00 - 22:00</option>
        <option className="hover:bg-black hover:text-white" value="22:00 - 23:00">22:00 - 23:00</option>
        <option className="hover:bg-black hover:text-white" value="23:00 - 00:00">23:00 - 00:00</option>
      </select>
      <label>Ile osób:</label>
      <select className="select bg-white text-black border-1 border-black rounded p-2" onChange={(e) => setGuestNumber(parseInt(e.target.value))} defaultValue={"2"}>
